...
function Bump(pos, ch) {
  this.pos = pos;
  this.size = new Vector(1, 1);
  if (ch == "b") {
    //bumper first number is horizontal speed, second is vertical?
    this.speed = new Vector(0, 0);
  } 
}
Bump.prototype.type = "bump";
...
Player.prototype.act = function(step, level, keys) {
  ...
  if (level.status == "catapult"){
    this.pos.x = this.pos.x - (2 * step);
  }
};
